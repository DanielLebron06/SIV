...
namespace SIV.Presentation.Desktop.Formularios.Reportes
{
    public class FrmReportes : Form
    {
        ...
        private async System.Threading.Tasks.Task GenerarReportes()
        {
            ...
            {
                MessageBox.Show(MensajesError.ObtenerMensaje(ex), "Error al generar reporte", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private async System.Threading.Tasks.Task ExportarCsv()
        {
            ...
            {
                MessageBox.Show(MensajesError.ObtenerMensaje(ex), "Error al exportar reporte", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
    }
}
